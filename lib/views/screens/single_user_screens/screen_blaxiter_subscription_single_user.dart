...
//
// class ScreenBlaxiterSubscription extends StatelessWidget {
//    ScreenBlaxiterSubscription({super.key});
//   final List<String> detailsSingleUser = [
//     'Unlimited Profiles',
//     'Unlimited Chats',
//     'See who viewed you',
...
//                 text: "See who likes you and match\nwith them instantly with Blaxity\ngold.",).marginSymmetric(
//                 vertical: 10.sp,
//               ),
//             ),
...
//                   ListView.builder(
//                     shrinkWrap: true,
//                     itemCount: detailsSingleUser.length,
//                     itemBuilder: (context, index) {
//                       return Row(
//                         children: [
//                           Icon(
//                               Icons.fiber_manual_record),
//                           Text(detailsSingleUser[index], style: TextStyle(
//                             color: Colors.white,
//                             fontSize: 13.sp,
