...
import '../../layouts/item_card_couple.dart';
            ...
            children: [
              Obx(() {
                return controllerGetUserAllData.isLoading.value
                  ...
                  color: Color(0xFFA7713F),
                    ...
                    child: GradientText(
                      text: "No User Found", style: TextStyle(color: Colors
              ...
              Obx(() {
                return (blogsController.isLoading.value)
                    ...
                    child: GradientText(
                      text: "No blogs found", style: TextStyle(color: Colors
                        .white, fontSize: 20.sp
                        , fontWeight: FontWeight.w600),))
                    : SizedBox(
              ...
              Obx(() {
                return (Get.find<ControllerHome>().user.value!.user.boostStatus=="0")?Container(
                  height: 184.h,
                  width: Get.width,
                  margin: EdgeInsets.symmetric(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        "Get Boost",
                        style: AppFonts.titleSuccessFullPassword.copyWith(fontSize: 24.sp
),
                      ),
                      Text(
                          style: AppFonts.subtitle,
