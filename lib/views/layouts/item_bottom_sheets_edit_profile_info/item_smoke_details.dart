...
class ItemSmokeDetailsBottomSheet {
  ...
  static void show(BuildContext context, User user) {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        ...
        selectedOption.value=user.additionalInfo!.smokingHabit ?? '';
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GradientText(
                      text: "How often do you smoke?", style: AppFonts.subscriptionBlaxityGold).paddingSymmetric(
                    vertical: 6.h,
                  ),

                  Wrap(children: List.generate(
                      controllerRegistration.smokingHabits.length,
                          (value) {
                        return Obx(() {
                          return IntrinsicWidth(
                            child: buildSelectOneOption(
                                controllerRegistration.smokingHabits[value],
                                    () {
                      ...
                      onTap: () async {
                        if (selectedOption.value.isNotEmpty) {
                          await controllerRegistration.updateCoupleProfile(
                              user, smokingHabit: selectedOption.value);
                          Get.back();
                        }
                        else {
