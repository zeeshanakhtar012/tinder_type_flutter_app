...
class ItemLookingForBottomSheet {
  ...
  static void show(BuildContext context, User user) {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        selectedOptions.value = user.userType=="couple"?user.commonCoupleData!.lookingFors!.toList():user.reference!.lookingFor!.toList() ?? [];
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GradientText(
                      text: "What are you looking for?", style: AppFonts.subscriptionBlaxityGold).paddingSymmetric(
                    vertical: 6.h,
                  ),
                      ...
                      onTap: () async {
                        if (selectedOptions.value.isNotEmpty) {
                          await controllerRegistration.updateCoupleProfile(
                              user, lookingFor: selectedOptions.value);
                          Get.back();
                        }
                        else {
                          FirebaseUtils.showError("Please select your Looking For.");
                        }
                      },
