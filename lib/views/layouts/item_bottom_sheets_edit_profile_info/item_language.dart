  ...
  static void show(BuildContext context, User user) {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        selectedOptions.value=user.reference!.language ??[];
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GradientText(
                      text: "Language Spoken", style: AppFonts.subscriptionBlaxityGold).paddingSymmetric(
                    vertical: 6.h,
                  ),

                  CustomChipsChoice<String>(
                    options: controllerRegistration.selectLanguages,
                      ...
                      onTap: () async {
                        if (selectedOptions.value.isNotEmpty) {
                          await controllerRegistration.updateCoupleProfile(
                              user, languages: selectedOptions.value);
                          Get.back();
                        }
                        else {
                          FirebaseUtils.showError("Please select your Languages.");
                        }
                      },
