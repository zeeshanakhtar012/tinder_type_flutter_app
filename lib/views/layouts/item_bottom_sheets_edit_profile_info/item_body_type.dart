  ...
  static void show(BuildContext context, User user) {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        selectedOption.value= user.additionalInfo?.bodyType ?? '';
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GradientText(
                      text: "What’s your body type?", style: AppFonts.subscriptionBlaxityGold).paddingSymmetric(
                    vertical: 6.h,
                  ),

                  Wrap(children: List.generate(
                      controllerRegistration.bodyTypes.length,
                          (value) {
                        return Obx(() {
                          return IntrinsicWidth(
                            child: buildSelectOneOption(
                                controllerRegistration.bodyTypes[value],
                                    () {
                      ...
                      onTap: () async {
                        if (selectedOption.value.isNotEmpty) {
                          await controllerRegistration.updateCoupleProfile(
                              user, bodyType: selectedOption.value);
                          Get.back();
                        }
                        else {
                          FirebaseUtils.showError("Please select body type.");
                        }
                      },
