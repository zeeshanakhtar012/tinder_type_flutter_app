...
class ItemInviteUserAnonymous extends StatefulWidget {
  final String text;
  ...
  @override
  _ItemInviteUserAnonymousState createState() => _ItemInviteUserAnonymousState();
}

class _ItemInviteUserAnonymousState extends State<ItemInviteUserAnonymous> {
