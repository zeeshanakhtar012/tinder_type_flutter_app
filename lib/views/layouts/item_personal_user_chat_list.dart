...
import 'package:blaxity/controllers/controller_personal_chat.dart';
...
class ItemPersonalUserChatList extends StatelessWidget {
  final LastMessage lastMessage;

  ItemPersonalUserChatList({
  ...
  Widget build(BuildContext context) {
    ...
    final ItemChatController controller = Get.put(ItemChatController(), tag: lastMessage.chatRoomId);
    ChatPersonalController controllerPersonalChat = Get.put(
        ChatPersonalController());
                  ...
                  FadeTransition(
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          onTap: () {
                            _showBottomSheet(user, context,lastMessage);
                          },
                          child: Container(
                            height: 75.h,
                            width: 54.w,
                            ...
                            children: [
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(  controllerPersonalChat.archiveIds.length.toString()),
                                  ),
                                ),
                              ),
                              IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (controllerPersonalChat.isArchive
                                      .value) {
                                    await ArchiveManager.unarchiveRoom(
                                        lastMessage.chatRoomId);
                                    print('Unarchived: ${lastMessage
                                        .chatRoomId}');
                                  } else {
                                    await ArchiveManager.archiveRoom(
                                        lastMessage.chatRoomId);
                                    print('Archived: ${lastMessage
                                        .chatRoomId}');
                                  }
...
class ItemChatController extends GetxController with GetSingleTickerProviderStateMixin {
