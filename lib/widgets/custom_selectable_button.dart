...
class CustomSelectbaleButton extends StatefulWidget {
  final double width;
  final double height;
...
class _GradientBorderContainerState extends State<CustomSelectbaleButton> {
  ...
  @override
  void didUpdateWidget(covariant CustomSelectbaleButton oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle buttonTextStyle = TextStyle(
      ...
      color: !_isSelected ?  Color(0xFF5B5B5B):Colors.white,
    );
